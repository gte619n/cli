...
version: 1.0.0
description: "Gmail: Draft a reply to a message (handles threading automatically, drafts-only mode)."
metadata:
  openclaw:
...
Draft a reply to a message (handles threading automatically). Creates a draft in your Gmail Drafts folder — you must manually send from Gmail.
